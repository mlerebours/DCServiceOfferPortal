    ...
    app.homeApp = Backbone.Model.extend({
        ...
        sanitizeData: function () {
            ...
            $.each(e.posters, function (t, s) {
                ...
                e.nodes[o] = {}, e.nodes[o].id = o, e.nodes[o].name = s.NOM, e.nodes[o].label_position = i.label, e.nodes[o].center = i.center, e.nodes[o].color = "#" + n.defaultColor, e.nodes[o].paletteId = n.id, e.nodes[o].textfr = s.desc_fr, e.nodes[o].texten = s.desc_en, e.nodes[o].relations = _.without(d, void 0), e.nodes[o].isActive = "" !== s.JSON ? 1 : 0
            }), this.render()
        },
        render: function () {
...
!function (e) {
    ...
    app.homeView = Backbone.View.extend({
        ...
        updateDisclaimerThemed: function () {
            e(".disclaimer_content_inner[data-step='themed'] .disclaimer_theme").html(this.model.nodes[this.selectedPoster].name).css("color", this.model.nodes[this.selectedPoster].color), e(".disclaimer_content_inner[data-step='themed'] .disclaimer_content_text").html(this.model.nodes[this.selectedPoster]["text" + LANG]), e(".disclaimer_content_inner").removeClass("displayed"), e(".disclaimer_content_inner[data-step='themed']").addClass("displayed"), 1 === this.model.nodes[this.selectedPoster].isActive ? (e(".disclaimer_link").css("background-color", this.model.nodes[this.selectedPoster].color).css("display", "block").attr("href", "posters/" + this.model.nodes[this.selectedPoster].id), e(".disclaimer_block").css("display", "none")) : (e(".disclaimer_block").css("color", this.model.nodes[this.selectedPoster].color).css("display", "block"), e(".disclaimer_link").css("display", "none"))
        },
