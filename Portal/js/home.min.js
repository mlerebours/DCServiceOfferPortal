    ...
    app.homeApp = Backbone.Model.extend({
        ...
        sanitizeData: function () {
            ...
            $.each(e.posters, function (t, s) {
                ...
                e.nodes[o] = {}, e.nodes[o].id = o, e.nodes[o].name = s.NOM, e.nodes[o].subtitle = s.SUBTITLE, e.nodes[o].label_position = i.label, e.nodes[o].center = i.center, e.nodes[o].color = "#" + n.defaultColor, e.nodes[o].paletteId = n.id, e.nodes[o].textfr = s.desc_fr, e.nodes[o].texten = s.desc_en, e.nodes[o].relations = _.without(d, void 0), e.nodes[o].isActive = "" !== s.JSON ? 1 : 0
            }), this.render()
        },
        render: function () {
